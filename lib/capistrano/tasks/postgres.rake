namespace :load do
  task :defaults do
    ...
    set :postgres_remote_database_staging, ask('Remote Postgres Database:', 'staging_db')
    set :postgres_remote_database_live, ask('Remote Postgres Database:', 'live_db')
    set :postgres_remote_database_test, ask('Remote Postgres Test Database:', 'test_db')
